        ...
        <main class="hero">
            <div class="sub-bar">
                ...
                <div>
                    ...
                    <span class="p-tag" style="background-color: <?= $grupo['cor_fundo'] ?>; color: <?= $grupo['cor_letras'] ? 'white' : 'black' ?>; margin-bottom: 40px;">
                    ...
                    <div class="inferior">
                        ...
                        <?php else: ?>
                            <button onclick="participarGrupo(<?= $groupId ?>)"><i class="fas fa-circle-plus"></i> Participar</button>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
